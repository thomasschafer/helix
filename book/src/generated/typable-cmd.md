...
| `:open-no-completions`, `:onc` | Open a file from disk into the current view (with no filename completions). |
...
| `:buffer-move-left` | Move buffer to the left |
| `:buffer-move-right` | Move buffer to the right |
